...
protocol PhotoViewerVCDelegate{
    func getCurrentPhotos(photos:[UIImage]) -> Void
}
class PhotoViewerVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        backButton.addTarget(self, action: #selector(PhotoViewerVC.backButtonAction), for: .touchUpInside)
        ...
        deleteButton.addTarget(self, action: #selector(PhotoViewerVC.deleteButtonAction), for: .touchUpInside)
